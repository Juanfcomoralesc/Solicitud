...
<div class="main">
   ...
   <header>
    ...
    <section id="content"><div class="ic"><div class="inner_copy">All <a href="http://www.magentothemesworld.com" title="Best Magento Templates">premium Magento themes</a> at magentothemesworld.com!</div></div>
	 ...
	 $verificaregistro=mysql_query("select * from regconta where matricula='$matricula'",$conexion) or
     ...
     <center>
     <h2><span class="color-1">Ya se encuentra registrada en nuestra base la matricula </span>'.$matricula.'</h2>
   ...
   <div class="btns"><a type="submit"  class="button" value="Imprimir" href="generar.php">Generar Registro</a></div></div>';  
	 ...
	 { 
				...
				$result22 = mysql_query("SELECT * FROM regconta where session='$_REQUEST[session]'", $conexion);
            ...
            $result = mysql_query("SELECT * FROM regconta WHERE session='".$_REQUEST["session"]."'", $conexion)or
             die("Problemas en el select:".mysql_error());
         ...
         $registros=mysql_query("select * from alumnos where matricula='$matricula'",$conexion) or
         die("Problemas en el select:".mysql_error());
		 ...
		 $F=date('Y-m-d');
  		    	 ...
  		    	 mysql_query("insert into regconta(matricula,nombre,grupo,laboratorio,maquina,session,fechasolicitud) values ('$matricula','$nombre','$grupo','$lab','$maq','$_REQUEST[session]','$F')",
         ...
         echo '<h2><span class="color-1">Registro </span>exitoso!</h2><br>
        ...
        <div class="btns"><a type="submit"  class="button" value="Imprimir" href="generar.php">Generar Registro</a></div>';
