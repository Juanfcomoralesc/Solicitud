...
if(!isset($grupo) && empty($grupo) && !isset($matricula) && empty($matricula)){
...
<script>
alert('Lo sentimos, el contenido no puede ser visto debido a que no ha iniciado sesión.');
</script>
...
$widths=array(90,100); 
      ...
      $link=mysql_connect("localhost","root","root"); 
       ...
       $registros=mysql_query("select * from regconta where matricula=$matricula",$link) or
...
$pdf->Cell(0,-7,' Unidad de Aprendizaje: Contabilidad',0,1,'C');
$pdf->Ln(20);
$pdf->SetFont('Arial','b',13); 
$pdf->Cell(0,5,' Nombre: '.$nom,0,1);
$pdf->Cell(0,5,' Matricula: '.$mat,0,1);
$pdf->Cell(0,5,' Grupo: '.$grupo,0,1);
$pdf->Ln(10);
